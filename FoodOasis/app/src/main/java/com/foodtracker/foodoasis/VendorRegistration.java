...
public class VendorRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newEmail = (EditText) findViewById(R.id.editTxtEmail);
        newPass = (EditText) findViewById(R.id.editTxtPwd);
        confirmPass = (EditText) findViewById(R.id.editTxtConfirmPwd);
        ...
        hasAccountButton = (Button) findViewById(R.id.hasAccountBtn);
